% This function estiamtes the Kolmogorov Complexity of a binary sequence. The 
% algorithm is as described in Lempel and Ziv (IEEE trans inf theory IT-22, 75 
% (1976)) and Kaspar and Schuster (Physical Review A, vol 36, no 2, pg 842).

% Input is binary sequence, output is kolmogorov complexity.

% Cite As
% Stephen Faul (2020). Kolmogorov Complexity 
% (https://www.mathworks.com/matlabcentral/fileexchange/6886-kolmogorov-complexity), 
% MATLAB Central File Exchange. Retrieved December 12, 2020.
